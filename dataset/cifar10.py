...
if __name__ == "__main__":
    ...
    train_dataset = CustomCIFAR10Dataset(root=root, train=True, transform=transform)
    test_dataset = CustomCIFAR10Dataset(root=root, train=False, transform=transform)
