...
from train.vit_imagenet_af import vit_af_train
from train.vit_imagenet_af_ddp import vit_imagenet_af_ddp_train
...
def main(args):
    ...
    elif args.task == "vit_imagenet_af":
        vit_af_train(args=args)
    elif args.task == "vit_imagenet_af_ddp":
        vit_imagenet_af_ddp_train(args=args)
    elif args.task == "vit_imagenet_ddp":
        vit_ddp(args=args)
    elif args.task == "mae_imagenet":
        mae_pretrain(args=args)
    elif args.task == "mae_imagenet_ddp":
        mae_pretrain_ddp(args=args)
    elif args.task == "map_s8d":
        map_s8d_pretrain(args=args)
    elif args.task == "btcv":
        btcv_iter(args=args)
